        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-64">
                <DropdownMenuLabel className="flex flex-col gap-0.5 py-3">
                    <span className="text-body-bolder text-dark-gray">
                        {user.name}
                    </span>
                    <span className="text-small text-medium-gray font-normal">
                        {user.email}
                    </span>
                </DropdownMenuLabel>
                ...
                <DropdownMenuItem asChild>
                    ...
                    >
                        <LayoutDashboard className="size-4 text-medium-gray" />
                ...
                <DropdownMenuItem asChild>
                    <Link
                        ...
                        className="w-full flex items-center gap-2 cursor-pointer"
                    >
                        <User className="size-4 text-medium-gray" />
